        ...
        <form onSubmit={submit} noValidate>
          ...
          {(quote || quoteError) && <div className="quote-summary" aria-live="polite">
            {quote ? <>
              ...
              {quote.directDiscountAmount > 0 && <div className="quote-summary__saving"><span>Vantagem reserva direta</span><strong>−{currency(quote.directDiscountAmount, quote.currency)}</strong></div>}
