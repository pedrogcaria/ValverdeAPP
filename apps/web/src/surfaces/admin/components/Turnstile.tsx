...
type Props = { action: 'login' | 'password_reset'; onTokenChange: (token: string | null) => void; resetSignal?: number };

export function Turnstile({ action, onTokenChange, resetSignal = 0 }: Props) {
